...
// (DO NOT EDIT: machine generated header) 'Xml.xmlutil.pas' rev: 35.00 (Windows)
...
typedef System::StaticArray<System::UnicodeString, 2> Xml_Xmlutil__2;

typedef System::StaticArray<System::UnicodeString, 2> Xml_Xmlutil__3;
...
extern DELPHI_PACKAGE Xml_Xmlutil__2 XSDBoolStrs;
extern DELPHI_PACKAGE Xml_Xmlutil__3 XSDBoolIntStrs;
...
extern DELPHI_PACKAGE int __fastcall XmlStrToInt(const System::UnicodeString Value);
extern DELPHI_PACKAGE System::UnicodeString __fastcall XmlIntToStr(const int Value);
extern DELPHI_PACKAGE __int64 __fastcall XmlStrToInt64(const System::UnicodeString Value);
extern DELPHI_PACKAGE System::UnicodeString __fastcall XmlInt64ToStr(const __int64 Value);
extern DELPHI_PACKAGE bool __fastcall XmlStrToBool(const System::UnicodeString Value);
extern DELPHI_PACKAGE System::UnicodeString __fastcall XmlBoolToStr(const bool Value);
extern DELPHI_PACKAGE System::TDateTime __fastcall XmlStrToDateTime(const System::UnicodeString Value);
extern DELPHI_PACKAGE System::UnicodeString __fastcall XmlDateTimeToStr2(const System::TDateTime Value);
}	/* namespace Xmlutil */
}	/* namespace Xml */
